 ...
 * @LastEditTime: 2024-05-06 17:52:04
    ...
    image: (
      <Box fontFamily="default">
        <div tw="flex flex-col w-full h-full" style={{
          ...
          <div tw="flex flex-col w-full justify-center h-1/5">
            <Image
                height=""
                src="/redbanner3.png"
              />
          ...
          <div tw="flex flex-col w-full justify-center items-center h-1/4 my-5">
            <div tw="flex flex-col bg-yellow-50 rounded-md border-8 border-solid border-lime-500 w-3/4">
