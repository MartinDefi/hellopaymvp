 ...
 * @LastEditTime: 2024-05-06 18:44:17
...
app.frame('/', (c) => {
  ...
  return c.res({
      ...
      <Box fontFamily="default">
        <div tw="flex flex-col w-full h-full" style={{
          ...
          <div tw="flex flex-col w-full justify-center items-center h-1/4 my-5">
            <div tw="flex flex-col bg-yellow-50 rounded-md border-8 border-solid border-violet-500 w-5/6">
    ...
    intents: [
      ...
      <Button value="bananas">Join Airdrop 1</Button>,
