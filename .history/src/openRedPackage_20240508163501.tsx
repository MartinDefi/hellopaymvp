 ...
 * @LastEditTime: 2024-05-08 16:34:16
            ...
            <Box fontFamily="default">
                <div tw="flex flex-col w-full h-full" style={{
                    ...
                    <div tw="flex flex-col w-full justify-center items-center h-1/4 my-5">
                        <div tw="flex flex-col bg-yellow-50 rounded-md border-4 border-solid border-violet-700 w-5/6">
                    ...
                    <div tw="flex w-full justify-center h-1/5 items-center" style={{ fontSize: 30, fontWeight: 700, color: '#feff00' }}>Follow HelloPay’s Farcaster Bro!</div>
                </div>
