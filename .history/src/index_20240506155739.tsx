 ...
 * @LastEditTime: 2024-05-06 15:57:39
    ...
    image: (
      <Box fontFamily="default">
        <div tw="flex flex-col w-full h-full" style={{
          ...
          <div tw="flex flex-col w-full justify-center p-10 h-1/4 bg-yellow-50">
            <div tw="flex justify-between items-center px-10 py-2 w-full rounded-md border-2 border-double border-lime-500">
