 ...
 * @LastEditTime: 2024-05-07 11:39:50
...
app.frame('/', (c) => {
    ...
    return c.res({
        ...
        intents: [
            ...
            <Button value="apples" action='/step2'>Lucky Money Red Package</Button>,
            <Button value="oranges" action: '/step2'>Common Red Package</Button>,
