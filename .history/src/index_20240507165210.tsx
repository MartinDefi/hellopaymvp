 ...
 * @LastEditTime: 2024-05-07 16:51:41
    ...
    image: (
      <Box fontFamily="default">
        <div tw="flex flex-col w-full h-full" style={{
          ...
          <div tw="flex flex-col w-full justify-center items-center h-1/6 mb-10">
            <Image
                objectFit="cover"
                src="/yellowribbon.png"
              />
            <div style={{ fontFamily: "'Gloria Hallelujah', monospace", fontSize: 30, fontWeight: 700, color: '#fff' }}>
              Crypto Red Package</div>
          ...
          <div tw="flex flex-col w-full justify-center my-2">
            <Image
                borderRadius="48"
                height="48"
                width="48"
                src="https://i.seadn.io/gae/lhGgt7yK1JiBVYz_HBxcAmYLRtP03aw5xKX4FgmFT9Ai7kLD5egzlLvb0lkuRNl28shtjr07DC8IHzLUkTqlWUMndUzC9R5_MSxH3g?w=500&auto=format"
              />
            {/* <img
                style={{ objectFit: "cover" }}
                tw="absolute inset-0 w-full h-full flex"
