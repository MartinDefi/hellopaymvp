 ...
 * @LastEditTime: 2024-05-06 16:06:16
    ...
    image: (
      <Box fontFamily="default">
        <div tw="flex flex-col w-full h-full" style={{
          ...
          <div tw="flex flex-col w-full justify-center align-center mx-5 h-1/4">
            <div tw="bg-yellow-50 rounded-md border-2 border-double border-lime-500 w-full">
