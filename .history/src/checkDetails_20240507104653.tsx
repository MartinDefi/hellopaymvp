 ...
 * @LastEditTime: 2024-05-07 10:45:40
...
app.frame('/', (c) => {
    ...
    return c.res({
        ...
        intents: [
            ...
            <Button action="/openRedPackage" value="apples">🧧 Open Red Packet onchain</Button>,
            <Button.Link action="/openRedPackage" value="apples">🧧 Open Red Packet onchain</Button.Link>,
