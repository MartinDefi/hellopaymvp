 ...
 * @LastEditTime: 2024-05-08 15:52:08
      ...
      <Box fontFamily="default">
        <div tw="flex flex-col w-full h-full" style={{
          ...
          <div tw="flex w-full justify-center items-center my-2">
            <div tw="flex pr-2" style={{ fontFamily: "M PLUS Rounded 1c', monospace", fontSize: 30, fontWeight: 700, color: '#000' }}>
              Send by 
            </div>
            <Image
                borderRadius="48"
          ...
          <div tw="flex w-full justify-center h-1/4 items-center" style={{ fontSize: 30, fontWeight: 700, color: '#000' }}>Follow HelloPay’s Farcaster Bro!</div>
        </div>
