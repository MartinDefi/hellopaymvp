 ...
 * @LastEditTime: 2024-05-07 16:48:18
    ...
    image: (
      <Box fontFamily="default">
        <div tw="flex flex-col w-full h-full" style={{
          ...
          <div tw="flex flex-col w-full justify-center h-1/6 mb-10">
            <Image
                src="https://i.seadn.io/gae/lhGgt7yK1JiBVYz_HBxcAmYLRtP03aw5xKX4FgmFT9Ai7kLD5egzlLvb0lkuRNl28shtjr07DC8IHzLUkTqlWUMndUzC9R5_MSxH3g?w=50&auto=format"
              />
            {/* <img
                style={{ objectFit: "cover" }}
                tw="absolute inset-0 w-full h-full flex"
