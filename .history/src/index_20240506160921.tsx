 ...
 * @LastEditTime: 2024-05-06 16:08:22
    ...
    image: (
      <Box fontFamily="default">
        <div tw="flex flex-col w-full h-full" style={{
          ...
          <div tw="flex flex-col w-full justify-center items-center mx-5 h-1/4">
            <div tw="flex flex-col bg-yellow-50 rounded-md border-2 border-dashed border-lime-500 w-3/4">
