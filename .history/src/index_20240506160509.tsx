 ...
 * @LastEditTime: 2024-05-06 16:05:08
    ...
    image: (
      <Box fontFamily="default">
        <div tw="flex flex-col w-full h-full" style={{
          ...
          <div tw="flex flex-col w-full justify-center items-center mx-5 h-1/4 bg-yellow-50  rounded-md border-2 border-double border-lime-500">
            <div tw="flex justify-between items-center px-10 py-2 w-3/4">
