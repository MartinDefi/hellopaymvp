 ...
 * @LastEditTime: 2024-05-07 16:53:51
        ...
        <div tw="flex flex-col w-full h-full" style={{
          ...
          <div tw="flex w-full justify-center items-center my-2">
            <Image
              ...
              />
            <div tw="pl-2" style={{ fontFamily: "'Gloria Hallelujah', monospace", fontSize: 30, fontWeight: 700, color: '#fff' }}>
              Send by {response.display_name}
            </div>
          </div>
